  ...
  _createClass(Palette, [{
    ...
    value: function renderItem(color, k) {
      ...
      return _react["default"].createElement("li", {
        ...
        onClick: function onClick(e) {
          return _this._onClickItem(color);
        },
        style: {
    ...
    value: function render() {
      ...
      return _react["default"].createElement("nav", {
        className: (0, _classnames["default"])('cpPalette', props.className)
      }, _react["default"].createElement("ul", null, props.colors.map(this.renderItem.bind(this))));
    }
  }]);
